...
import type { BibliographyView, FigureReplacement, PaperCommand, PaperView, ProposalInput, ProposalRevisionInput } from './schema.ts';
/**
...
export declare class PaperStore {
    ...
    private readonly maxFigureBytes;
    private root;
    private stateRoot;
    private releaseLock;
    private tail;
    ...
    constructor(workspaceRoot: string, maxBytes: number, maxFigureBytes?: number);
     ...
     */
    listFiles(path: string, extension?: 'md' | 'bib' | 'figure'): Promise<{
        path: string;
        entries: {
            name: string;
            type: 'directory' | 'file';
