...
import type { BibliographyView, FigureReplacement, FileListing, PaperCommand, PaperView } from '../schema.ts';
...
export declare const WordDiff: import("react").MemoExoticComponent<({ before, after, labels, markdownLabels, findId }: {
    before: string;
    after: string;
    labels: {
        compare: string;
 ...
 */
export declare function PaperPanel({ useTabInfo, useSession, useInput, sessionId, inputActions, t, command, listFiles, pickFile, currentFile, bibliography, bindBibliography, pickBibliography, pickFigure, listFigureFiles, replaceFigure, figurePath, figureThumbnail, figurePage, figureBytes, leave, }: PaperPanelProps): ReactNode;
