...
import type { Annotation, PaperBlock, PaperHighlight } from '../schema.ts';
 ...
 */
export declare function ReaderText({ block, highlights, annotations, labels, onSelect, onMenu, comparison }: {
    block: PaperBlock;
